// InstantTeleportationVanillaCooldowns, Valheim mod that changes how teleportation works
...
namespace InstantTeleportationVanillaCooldowns
{
    [BepInPlugin(pluginGUID, pluginName, pluginVersion)]
    public class InstantTeleportationVanillaCooldowns : BaseUnityPlugin
    {
        const string pluginGUID = "InstantTeleportationVanillaCooldowns";
        const string pluginName = "Instant Teleportation Vanilla Cooldowns";
        const string pluginVersion = "1.0.1";
        public static readonly Harmony harmony = new Harmony("InstantTeleportationVanillaCooldowns");
